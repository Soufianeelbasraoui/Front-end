  ...
  return (
    <div className='center-container'>
         <div className="form sign-up ">
          ...
          <input type="text" placeholder="Nom" className="m-1"/>
          <input type="email" placeholder="Email"className="m-1" />
          <input type="password" placeholder="Mot de passe" className="m-1" />
          <button className="button2 m-1">Créer le compte</button>
        </div>
    </div>
  )
}
